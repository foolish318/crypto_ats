...
public final class DepthLatencyStats {
    ...
    public DepthLatencyStats(String name, int capacity) {
        this.name = name;
    ...
    public synchronized void record(DepthLatencyEnvelope envelope, long processingStartNanos, long processingEndNanos,
                                    TradingSignal signal) {
        DepthMarketDataRecord record = envelope.record();
        ...
        bookLatencies[index] = record.bookUpdatedNanos() - record.parsedNanos();
